...
# Convert the snowpark datafram to a pandas one so we can use the LOC function
...
if ingredients_list:
    ...
    for fruit_chosen in ingredients_list:
        ...
        smoothiefroot_response = requests.get(f"https://www.smoothiefroot.com/api/fruit/watermelon{search_on}")  
